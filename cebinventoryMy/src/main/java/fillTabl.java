 ...
 * @author Isuru
 */
public class fillTabl extends HttpServlet {
...
List empList = session.createQuery("from owner_item_master").list();
...
pw.println(oim.getItem_code()+":"+StatusConverter.convertDigitsToString(oim.getStatus())+":"+oim.getUser_name()+":"+oim.getQuantity()+":"+im.getRemarks()+":"+im.getPrice()+":"+im.getValue()+"%");
}
tx.commit();
}catch(Exception e){
    tx.rollback();
