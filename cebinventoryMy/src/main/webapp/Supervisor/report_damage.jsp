...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
        ...
        <script type="text/javascript">
            ...
            function handleServerResponse1() {
                if (xmlhttp.readyState == 4) {
                    if(xmlhttp.status == 200) {
                        ...
                        var numOfOptions = DropDown.options.length
                        for (j=0; j<numOfOptions; j++) {
                            DropDown.remove(j)
                        }

                        var theDropDown = document.getElementById("select1")
            ...
            function validateFormOnSubmit1(theForm){
                ...
                reason += validateEmpty(theForm.txtname," Enter an Item Code");


                reason += validateEmpty(theForm.textfield4," Enter Quantity");
                reason += validateEmpty(theForm.textfield2," Enter Cause for the change");
                        ...
                        <div class="storycontent">
                            <form name="myForm" id="myForm" action="">
                                <table width="327" border="0" cellpadding="1" cellspacing="1">
                                    ...
                                    <tr>
                                        <td>New Status: </td>
                                        <td colspan="2"><select name="select" id="select" onblur="AddItem()">
                                    ...
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td width="54"><label>
                                                <input name="b_report" type="button" id="b_report" value="Report" onclick="validateFormOnSubmit1(myForm);" />
                                            </label></td>
