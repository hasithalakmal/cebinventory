...
<div id="hom_hea"><img src="../files/header.jpg" alt="Medical" title="Plethora- Inventory Management System." height="85" width="1290"></div>
  ...
  <div id="content">
    ...
    <div class="post">
      ...
      <div class="storycontent">
        <jsp:include page="../edit_user" flush="true"/>
