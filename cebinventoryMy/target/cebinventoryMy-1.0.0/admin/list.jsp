...
function load(){
    //un=username;
    var url="../ItemList2?parameter=load";
    var xmlHttp;
...
<div id="men"><a href="approve_damaged_items.jsp">Approve Item Status Changes</a><a href="confirm_annual_verification.jsp">Approve Annual Verifications</a><a href="add_to_auction.jsp">Approve Auctioning Items</a><a href="approve_adjustments.jsp">Approve Item Adjustments</a><a href="edit_profile.jsp">Edit Profile</a><a href="get_item_status.jsp">Inquiries</a><a href="get_item_status.jsp">Reports</a></div>
<div id="pri">
<div id="con_int">
  <div id="content">
    <!-- end header -->
