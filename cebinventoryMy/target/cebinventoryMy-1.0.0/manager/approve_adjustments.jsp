...
function searchData(num){
    adjNo = num;
    var url="../ApproveAdjustmentsServlet?parameter=search&adjustmentNo="+num;
    var xmlHttp;
    ...
    xmlHttp.onreadystatechange = function(){
        if (xmlHttp.readyState == 4){
            ...
            for(var i=0; i<temp.length-1; i++){
                ...
                c1.setAttribute("name", "Y_"+temp1[0]+"_"+temp1[8]+"_"+temp1[2]+"_"+temp1[4]+"_"+temp1[9]);
                ...
                c3.setAttribute("name", "N_"+temp1[0]+"_"+temp1[8]+"_"+temp1[2]+"_Y_"+temp1[9]);
...
function view(){
    var url="../ApproveAdjustmentsServlet?parameter=view";
    var xmlHttp;
    if(window.XMLHttpRequest){ // For Mozilla, Safari, ...
        var xmlHttp = new XMLHttpRequest();
    }
...
function update(button){
    ...
    var tmp = new Array();
    tmp = param.split("_")
    var url="../ApproveAdjustmentsServlet?parameter=update&type="+tmp[0]+"&itemCode="+tmp[1]+"&userName="+tmp[2]+"&status="+tmp[3]+"&availableQuantity="+tmp[4]+"&adjustmentNo="+tmp[5];
    var xmlHttp;
    if(window.XMLHttpRequest){ // For Mozilla, Safari, ...
        var xmlHttp = new XMLHttpRequest();
    }
...
function updateAll(type){
    ...
    if(confirm("Are you sure that you want to proceed with the \""+typ+"\" action?")){
        var url="../ApproveAdjustmentsServlet?parameter=updateAll&type="+type+"&adjustmentNo="+adjNo;
        var xmlHttp;
        if(window.XMLHttpRequest){ // For Mozilla, Safari, ...
            var xmlHttp = new XMLHttpRequest();
        }
...
<div id="con_int">
  <div id="content">
    ...
    <div class="post">
      ...
      <h2>Approve Item Adjustments</h2>
      ...
      <form id="f1">
        <table  border="0">
          <tr>
            ...
            <td width="5">&nbsp;</td>
            <td ><input type="text" name="adjno" /> </td>
            <td width="13">&nbsp;</td>
            <td ><input type="button" name="Search" value="Search" onclick="searchData(adjno.value)" /> </td>
            <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
            <td ><input type="button" name="View Adjustment List" value="View Adjustment List" onclick="view()" /> </td>
          </tr>
          <tr>
            <td colspan="2">&nbsp;</td>
          </tr>
          ...
          <tr>
            ...
            <table id="t1" width="795" border="1">
              <tr>
                ...
                <td width="106"  bordercolor="#000000" bgcolor="#696969"><font color='white'>Actual Quantity</font></td>
                <td width="134"  bordercolor="#000000" bgcolor="#696969"><font color='white'>Available Quantity</font></td>
                <td width="134"  bordercolor="#000000" bgcolor="#696969"><font color='white'>Difference</font></td>
                <td width="134"  bordercolor="#000000" bgcolor="#696969"><font color='white'>Remarks</font></td>
